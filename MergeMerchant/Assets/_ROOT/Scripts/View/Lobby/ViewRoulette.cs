...
namespace MJGame.MergeMerchant.Lobby
{
    public class ViewRoulette : MonoBehaviour
    {
        ...
        private void AddReward()
        {
            ...
            SingletonComponent<VFXParticleItem>.Instance.OnClickItemVFX(transform.position + new Vector3(0, -200, 0), _rw / 2, viewItemRoulettes[_idx].nameItem, GIE.GetItemEffectType.JumpAway_First);
        }
